...
card.plainApdu(WRITE_MEMORY_CARD1F);//1envío C-APDU de lectura
card.plainApdu(WRITE_MEMORY_CARD1C);//1envío C-APDU de lectura
card.plainApdu(WRITE_MEMORY_CARD1D);//1envío C-APDU de lectura
card.plainApdu(WRITE_MEMORY_CARD1E);//1envío C-APDU de lectura
print("Sector 7 SW: " + card.SW.toString(HEX));

card.plainApdu(Sector8);
card.plainApdu(WRITE_MEMORY_CARD23);//1envío C-APDU de lectura
card.plainApdu(WRITE_MEMORY_CARD20);//1envío C-APDU de lectura
card.plainApdu(WRITE_MEMORY_CARD21);//1envío C-APDU de lectura
card.plainApdu(WRITE_MEMORY_CARD22);//1envío C-APDU de lectura
